...
final class AlertView: UIView, NewYorkAlertViewType {
    ...
    private let titleLabel: UILabel = {
        ...
        label.font = .systemFont(ofSize: Const.FontSize.title, weight: .semibold)
...
//        view.backgroundColor = NewYorkDynamicColor.Background.separator
    ...
    private func setupViews(title: String?, message: String?) {
        ...
        constraints += [
            ...
            contentView.widthAnchor.constraint(lessThanOrEqualToConstant: UIScreen.main.bounds.width - 48)
        ]
